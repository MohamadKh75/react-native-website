...
You will need Node, the React Native command line interface, Python3, a JDK, and Android Studio.
...
<h3>Node, Python3, JDK</h3>

We recommend installing Node and Python3 via [Chocolatey](https://chocolatey.org), a popular package manager for Windows.

React Native also requires [Java SE Development Kit (JDK)](https://openjdk.java.net/projects/jdk8/), as well as Python3. Both can be installed using Chocolatey.

Open an Administrator Command Prompt (right click Command Prompt and select "Run as Administrator"), then run the following command:

```powershell
choco install -y nodejs.install python3 openjdk8
```
